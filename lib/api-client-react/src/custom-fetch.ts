...
export async function customFetch<T = unknown>(
  ...
  // Hub data can change from another device or the web dashboard at any time.
  // Request a fresh representation so a conditional 304 response is never
  // exposed to React Native as a failed request with no response body.
